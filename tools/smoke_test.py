...
def main():
    ...
    ckpt_path = config.LIFTER_CKPTS["shapenet_nmr"]
    ...
    with torch.no_grad():
        out = render_predicted(splats, w2v, full_proj, cam_center, bg, cfg, focals_pixels=None)
    img = out["render"]
