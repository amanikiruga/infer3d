...
def load_dataset(dataset_name, val_view, test_idx, train_example_ids, override_example_id, cfg):
    ...
    if dataset_name == "shapenet_nmr": 
        ...
        dataset = ShapenetNMR(cfg, "train", override_example_ids=train_example_ids, override_overall_view="side-top")
...
def main(cfg:  DictConfig): 
    ...
    results_save_path = f"{log_path}/side_top_so3_results.csv"
