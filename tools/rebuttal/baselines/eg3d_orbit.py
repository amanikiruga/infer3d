"""Render a free azimuth orbit (36 frames) of the EG3D-PTI reconstruction for each
object — for the comparison-video gallery. No GT-camera gauge needed (visualization).
Works for task A (input.png) and task B realcars (rgb_white_128.png)."""
...
from utils.camera_utils import LookAtPoseSampler  # noqa (via eg3d repo path in E)
dev = "cuda"
NF = 36
...
def main():
    ...
    ap.add_argument("--out", default=f"{WT}/rebuttal/results/orbits/eg3d_so3")
