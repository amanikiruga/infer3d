...
Usage:
  CUDA_VISIBLE_DEVICES=0 mamba run -n test2 python -u \
    experiments/realcars/splats_to_ply_realcars.py \
...
from infer3d.utils.optim import render_with_custom_camera_align
from scene.gaussian_predictor import GaussianSplatPredictor
from infer3d.data.srn import SRNDataset

device = torch.device("cuda")

OURS_OPT_ROOT = Path(_cfg.RUNS_ROOT) / "realcars_opt"
PSEUDO_GT_ROOT = Path(_cfg.REALCARS_PSEUDO_GT)
