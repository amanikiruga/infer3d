...
CSV_PATH = _cfg.REALCARS_TEST_CSV
OUT_DIR = Path(_cfg.RUNS_ROOT) / "realcars"
...
def scene_dir_for_idx(idx: str) -> str:
    ...
    # CSV stores paths relative to REALCARS_ROOT: HQ339/<scene>/frame_NNNNN.jpg
    return os.path.dirname(os.path.join(SCENES_ROOT, path))
