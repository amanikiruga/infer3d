...
from infer3d.utils.graphics import focal2fov
...
def render_predicted(pc : dict, 
    ...
    raster_settings = GaussianRasterizationSettings(
        image_height=image_height or int(cfg.data.training_resolution),
        image_width=image_width or int(cfg.data.training_resolution),
        tanfovx=tanfovx,
        tanfovy=tanfovy,
        bg=bg_color,
